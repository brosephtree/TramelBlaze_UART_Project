...
# Switches
set_property PACKAGE_PIN V17 [get_ports {baud[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {baud[0]}]
set_property PACKAGE_PIN V16 [get_ports {baud[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {baud[1]}]
set_property PACKAGE_PIN W16 [get_ports {baud[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {baud[2]}]
set_property PACKAGE_PIN W17 [get_ports {baud[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {baud[3]}]
set_property PACKAGE_PIN W15 [get_ports eight]					
	set_property IOSTANDARD LVCMOS33 [get_ports eight]
set_property PACKAGE_PIN V15 [get_ports pen]					
	set_property IOSTANDARD LVCMOS33 [get_ports pen]
set_property PACKAGE_PIN W14 [get_ports ohel]					
	set_property IOSTANDARD LVCMOS33 [get_ports ohel]
...
#set_property PACKAGE_PIN U17 [get_ports inc_dec_btn]						
#	set_property IOSTANDARD LVCMOS33 [get_ports inc_dec_btn]
